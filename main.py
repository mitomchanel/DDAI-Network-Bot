...
class DDAI:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}DDAI Network Bot{Fore.BLUE + Style.BRIGHT}
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}https://t.me/mitomchanel{Fore.YELLOW + Style.BRIGHT}
            """
        )
    ...
    def print_question(self):
        while True:
            try:
                print("1. Chạy Bot với proxy Free")
                print("2. Chạy Bot với Proxy riêng của bạn")
                print("3. Chạy Bot ko cần Proxy")
                choose = int(input("Chọn số và enter [1/2/3] -> ").strip())
    ...
    async def main(self):
        try:
            ...
            self.welcome()
            self.log(
                f"{Fore.GREEN + Style.BRIGHT}Tổng số Account: {Style.RESET_ALL}"
...
if __name__ == "__main__":
    try:
        ...
        print(
            ...
            f"{Fore.RED + Style.BRIGHT}Xong rồi nhá{Style.RESET_ALL}                                      ",                                       
        )